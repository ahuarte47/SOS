...
create index xmlFeatParamIdx on public.xmlfeatparamvalue (value);
create index xmlParamIdx on public.xmlparametervalue (value);
...
alter table public.observationhasoffering add constraint FK_s19siow5aetbwb8ppww4kb96n foreign key (observationId) references public.observation;
