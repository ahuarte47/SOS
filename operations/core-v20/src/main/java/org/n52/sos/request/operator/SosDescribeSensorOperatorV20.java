...
public class SosDescribeSensorOperatorV20 extends
    ...
    private void checkProcedureDescriptionFromat(String procedureDescriptionFormat, DescribeSensorRequest sosRequest, final RequestOperatorContext requestOperatorContext) throws MissingParameterValueException, OwsExceptionReport {
        if (!checkOnlyRequestableProcedureDescriptionFromats(sosRequest.getProcedureDescriptionFormat(), Sos2Constants.DescribeSensorParams.procedureDescriptionFormat, false, requestOperatorContext)) {
