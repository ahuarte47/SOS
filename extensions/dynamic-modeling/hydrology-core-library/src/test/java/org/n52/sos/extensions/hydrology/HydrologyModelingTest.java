...
public class HydrologyModelingTest 
{
    ...
    public void testHydraulicModels() 
    {
        ...
        try 
        {
            ...
            org.joda.time.DateTime timeFrom = ObservableObject.UNDEFINED_DATETIME_FILTER_FLAG;
            org.joda.time.DateTime timeTo = ObservableObject.UNDEFINED_DATETIME_FILTER_FLAG;
            ...
            for (Model model : modelManager.getModels())
            {
                ...
                if (model.prepareObject())
                {
                    ...
                    observableContextArgs.timeFrom = timeFrom;
                    observableContextArgs.timeTo = timeTo;
