...
public class ObservableAttribute 
{
    ...
    public ObservableAttribute(ObservableAttribute attribute)
    {
        ...
        timeFrom = attribute.timeFrom;
        timeTo = attribute.timeTo;
     ...
     */
    public org.joda.time.DateTime timeFrom;
    
    /**
     * Valid end TimePeriod date of the Attribute.
     */
    public org.joda.time.DateTime timeTo;
    ...
    {
        return String.format("Attribute=%s TimeFrom=%s TimeTo=%s StepTime=%d Units=[%s]", name, timeFrom.toString(), timeTo.toString(), stepTime, units!=null ? units : "");
    }
}
