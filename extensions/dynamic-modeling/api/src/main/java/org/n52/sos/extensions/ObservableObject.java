...
public class ObservableObject 
{
    ...
    public static final DateTime UNDEFINED_DATETIME_FILTER_FLAG = null;
    ...
    /**
     * Compose the SQL-where clause to apply the specified complex OR-filter (FieldName=value1[,value2,value3,...]).
     */
    public static String composeWhereClause(String fieldName, String fieldValue, boolean usingInClause)
    {
        if (fieldValue.indexOf(',')!=-1)
        {
            ...
            if (usingInClause)
            {
                ...
                for (String parseValue : fieldValue.split(","))
                {
                    stringBuilder.append("'");
