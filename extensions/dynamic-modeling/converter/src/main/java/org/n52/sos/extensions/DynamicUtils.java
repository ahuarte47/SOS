...
class DynamicUtils 
{
    ...
    {
        String complexId = identifierPrefix!=null ? identifierPrefix : "";
    ...
    {
        String idenPrefix = ServiceConfiguration.getInstance().isUseDefaultPrefixes() ? ServiceConfiguration.getInstance().getDefaultFeaturePrefix() : "feature";
        String identifier = theObject.objectName;
